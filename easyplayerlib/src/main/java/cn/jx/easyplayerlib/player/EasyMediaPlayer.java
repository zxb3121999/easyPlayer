...
public class EasyMediaPlayer extends AbstractMediaPlayer {
    ...
    @Override public void restart() throws IllegalStateException {
        _restart();
    }
    private native void _restart() throws IllegalStateException;
    @Override
    ...
    @Override public void setBackground(boolean background) {
        _canPlayBackground(background);
    }
    private native void _canPlayBackground(boolean canPlay);
    @Override public void setBackgroundState(boolean isInBackground) {
        _setBackgroundState(isInBackground);
    }
    public native void _setBackgroundState(boolean isBackground);
    public native void _prepareAsync() throws IllegalStateException;

    private native void _startRecorder(String path);
    @Override public void startRecorder(String path){
        _startRecorder(path);
    }
    ...
    private void postEventFromNative(int what, int arg1, int arg2,String msg) {
