...
import cn.zxb.media.recorder.EasyMediaRecorder
import cn.zxb.media.recorder.IMediaRecorder
...
class RecorderActivity : AppCompatActivity() {
  ...
  private val mCallback = Camera.PreviewCallback { data, _ ->
    if (data != null) {
  ...
  private fun initCamera() {
    ...
    mRecorder!!.setErrorListener { _, msg ->
      run {
        tv!!.text = "停止"
        Log.e(TAG, msg)
      }
